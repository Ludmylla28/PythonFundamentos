# Exercício 1 - Crie uma lista de 3 elementos e calcule a 
# terceira potência de cada elemento.
elementos = [4,5,9]
cubo = [i**3 for i in elementos]
print(cubo)
...
# encontre os valores que são comuns às duas listas 
# abaixo.
...
# Crie um terceiro dicionário com as chaves do 
# dicionário 1 e os valores do dicionário 2.
dict1 = {'a':1,'b':2}
dict2 = {'c':4,'d':5}
...
# retorne apenas os elementos cujo índice for maior 
# que 5.
